...
import com.sankarwap.googleplaces.adapter.DefaultAutocompleteAdapter;
import com.sankarwap.googleplaces.async.BackgroundExecutorService;
import com.sankarwap.googleplaces.async.BackgroundJob;
import com.sankarwap.googleplaces.history.AutocompleteHistoryManager;
import com.sankarwap.googleplaces.history.DefaultAutocompleteHistoryManager;
...
public class GooglePlacesAuto extends AppCompatAutoCompleteTextView {
    ...
    private OnClearListener defaultClearListener = new OnClearListener() {
        ...
        @Override
        public void onClear() {
            GooglePlacesAuto et = GooglePlacesAuto.this;
            et.setText("");
        }
    };
     ...
     */
    public GooglePlacesAuto(@NonNull final Context context, @NonNull final String googleApiKey) {
        super(context);
     ...
     */
    public GooglePlacesAuto(@NonNull final Context context, @NonNull final String googleApiKey, @NonNull final String historyFileName) {
        super(context);
     ...
     */
    public GooglePlacesAuto(final Context context, final AttributeSet attrs) {
        super(context, attrs);
     ...
     * Constructor for layout inflation
     */
    public GooglePlacesAuto(final Context context, final AttributeSet attrs, final int defAttr) {
    ...
    private void init(@NonNull final Context context, final AttributeSet attrs, final int defAttr, final int defStyle, final String googleApiKey, final String historyFileName) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.GooglePlacesAuto, defAttr, defStyle);
        String layoutApiKey = typedArray.getString(R.styleable.GooglePlacesAuto_pacv_googleMapsApiKey);
        String layoutAdapterClass = typedArray.getString(R.styleable.GooglePlacesAuto_pacv_adapterClass);
        String layoutHistoryFile = typedArray.getString(R.styleable.GooglePlacesAuto_pacv_historyFile);
        languageCode = typedArray.getString(R.styleable.GooglePlacesAuto_pacv_languageCode);
        resultType = AutocompleteResultType.fromEnum(typedArray.getInt(R.styleable.GooglePlacesAuto_pacv_resultType, PlacesApi.DEFAULT_RESULT_TYPE.ordinal()));
        clearEnabled = typedArray.getBoolean(R.styleable.GooglePlacesAuto_pacv_clearEnabled, false);
        typedArray.recycle();
